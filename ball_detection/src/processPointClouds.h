...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // RANSACE PLANE SEGMENTATION
    std::pair< pcl::ModelCoefficients::Ptr,  std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>> RANSAC_PlaneSegment_Scratch(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold);

  // RANSACE PLANE SEGMENTATION with initial
    std::pair< pcl::ModelCoefficients::Ptr,  std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>> RANSAC_PlaneSegment_with_init_Scratch(typename pcl::PointCloud<PointT>::Ptr cloud, pcl::ModelCoefficients::Ptr plane_coeff, int maxIterations, float distanceThreshold);
 
	std::pair<line_data, std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>> RANSAC_LineSegment_Scratch(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold);
	std::pair<PointT, std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr>>RANSAC_SphereSegment_Scratch(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float disttanceThreshold, float sphereRadius);
