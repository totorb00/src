...
enum CameraAngle
{
	XY, TopDown, Side, FPS, BehindCar, FromCamParamFile
};
...
void renderBox_params(pcl::visualization::PCLVisualizer::Ptr& viewer, Box_params box, int id, Color color = Color(1,0,0), float opacity=1);
